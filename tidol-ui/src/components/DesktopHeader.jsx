...
export default function DesktopHeader() {
    ...
    return (
        <header className="hidden md:flex fixed top-0 left-0 right-0 h-16 items-center px-8 md:pl-72 z-[60] bg-[#030303]/90 backdrop-blur-sm border-b border-white/5">
            {/* Search Bar (Centered) */}
            ...
            {/* Right Actions (Profile) - Absolute positioned to right */}
