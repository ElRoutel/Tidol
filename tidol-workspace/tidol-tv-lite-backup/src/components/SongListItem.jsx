...
function SongListItem({ song, onPlay, isActive }) {
    ...
    const title = song.trackName || song.title || song.titulo || 'Sin título';
    const artist = song.artistName || song.artist || song.artista || 'Desconocido';
    const cover = song.coverArtUrl || song.artworkUrl || song.portada || '/default_cover.png';
